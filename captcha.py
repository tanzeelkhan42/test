...
start = time()
url = 'https://www.yellowpages.com.au/search/listings?clue=Panel+Beater&eventType=pagination&locationClue=sydney+eastern+suburbs+nsw&pageNumber=7&referredBy=www.yellowpages.com.au'
